...
import com.example.chian.component.ChianChatTopBar
import com.example.chian.component.ChianTextField
...
fun ChatScreen(
    ...
    Column(
        ...
        LazyColumn(
            ...
            // 각 메시지에 고유 키를 설정: 여기서는 query를 사용
            items(chatMessageWithAuthor.value, key = { it.messageData.query }) { chatMessageWithAuthor ->
                ...
                Row(
                    ...
                    Box(
                        modifier = Modifier
                            ...
                            .widthIn(max = 300.dp)
                            .background(if (isSentByUser) mainColor else textFieldBackGroundColor)
